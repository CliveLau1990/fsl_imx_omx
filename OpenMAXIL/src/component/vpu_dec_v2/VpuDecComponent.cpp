...
OMX_ERRORTYPE OpenVpu(VpuDecHandle* pOutHandle, VpuMemInfo* pInMemInfo,
	VpuCodStd eCodeFormat, OMX_S32 nPicWidth,OMX_S32 nPicHeight,OMX_COLOR_FORMATTYPE eColorFormat,OMX_S32 enableFileMode,VPUCompSemaphor psem,OMX_BOOL bReorderDis,OMX_BOOL bAdaptiveMode, OMX_BOOL 
bSecureMode)
{
...
#endif
#endif
			if(OMX_ErrorNone!=OpenVpu(&nHandle, &sMemInfo, eFormat, sInFmt.nFrameWidth, sInFmt.nFrameHeight,sOutFmt.eColorFormat,enableFileMode,psemaphore,bReorderDisabled,bAdaptiveMode,bEnableSecureMode)) //1 sInFmt is valid ???
			{
